...
<body>
    <?php $bdd = mysqli_connect("127.0.0.1", "user", "mypass", "Extia_Coop");
    $query = 'SELECT Photo, CV, Nom, Prenom, Age, Origine, Pourquoi, Metier, Statut FROM Coopte WHERE ID_Cooptant="0"';
                    ...
                    <div class="col-md-18">
                        <div class="media-left"><span class="icon-lightbulb"></span></div>
                            ...
                            <table class="table-responsive">
                                ...
                                <td> CV uploadé</td>
                                <td> Nom et Prenom du Cooptant + lien </td>
                                <td> Pourquoi l'avoir coopté </td>
                                <td> 
                                <select>
