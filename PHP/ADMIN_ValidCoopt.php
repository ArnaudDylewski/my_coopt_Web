...
<body>
    ...
    $resultat = mysqli_query($bdd,'SELECT * FROM Validation');
    ?>
    <!-- Preloader
	============================================= -->
        ...
        <div class="container">
            ...
            <div class="services-box">
                <div class="row wow fadeInUp" data-wow-delay=".3s">
                    <?php
                    echo '
                    <a href="ADMIN_AjoutRH.php" class="btn btn-warning">Ajout RH</a>
                    <div class="col-md-18">
                        <div class="media-left"></div>
                            ...
                            <table class="table-responsive">
                                ...
                                if (mysqli_num_rows($resultat) == 0){
                                    echo "<tr><h3>Pas de RH inscrit<h3><tr>";
                                }
                                ...
                                echo '<tr>
                                    ...
                                    <th>'.$donnees['Login'].'</th>
                                    <th>'.$donnees['Email'].'</th>
                                    <th><a class="btn btn-success" href="validation.php?action=accepter&id='.$donnees['id'].'">Accepter</a></th>
                                    <th><a class="btn btn-danger href="validation.php?action=refuser&id='.$donnees['id'].'">Refuser</a></th>
                                    </tr>';
                                    if(isset($_GET['action']) AND isset($_GET['id']))
                                        ...
                                        {
                                            $id = $_GET['id'];
                                            $quete2 = mysqli_query($bdd, "SELECT * FROM validation WHERE id='$id'");
                                            $connexion = mysqli_fetch_assoc($quete2);
                                            
                                            mysqli_query($bdd, "INSERT INTO Utilisateur VALUES()");
                                            mysqli_query($bdd, "DELETE FROM validation WHERE id='$id'");
                                        }
